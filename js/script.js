	...
	// Assuming your services carousel has a class of 'services-carousel'
	$('.services-carousel').owlCarousel({
	loop: true,
	margin: 30,
	nav: false,
	...
	// Bind custom arrows to carousel actions
	$('.next-service-arrow').click(function () {
